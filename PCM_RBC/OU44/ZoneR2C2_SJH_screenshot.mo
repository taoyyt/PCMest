within OU44;
model ZoneR2C2_SJH_screenshot "Simple zone"
  ...
  Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor temperatureSensor
    annotation (Placement(transformation(extent={{62,112},{82,132}})));
...
equation
  ...
  connect(temperatureSensor.T, fromKelvin.Kelvin)
    annotation (Line(points={{82,122},{132,122},{132,120},{180,120}},
                                                             color={0,0,127}));
  ...
  connect(temperatureSensor.T, MetabolicHeat.u[1]) annotation (Line(points={{82,122},
          {90,122},{90,-14},{-168,-14},{-168,6},{-162.4,6}},
        color={0,0,127}));
  ...
  connect(temperatureSensor.port, air.port)
    annotation (Line(points={{62,122},{62,116},{46,116}},
                                                  color={191,0,0}));
  ...
  connect(re1.port_a, air.port) annotation (Line(points={{76,158},{62,158},{62,
          116},{46,116}},
                     color={191,0,0}));
  connect(temperatureSensor.T, airMix.Ti) annotation (Line(points={{82,122},{90,
          122},{90,-60},{0,-60},{0,-52.8}},           color={0,0,127}));
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-220,
        ...
        Text(
          extent={{-248,168},{-230,148}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="S
"),     Text(
          extent={{-248,92},{-230,72}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="To
"),     Text(
          extent={{-246,40},{-228,20}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Oc
"),     Text(
          extent={{-246,-42},{-228,-62}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Tv
"),     Text(
          extent={{-246,-76},{-228,-96}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="v
"),     Text(
          extent={{-246,-124},{-228,-144}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="q"),
        Text(
          extent={{-128,112},{-110,92}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Re
...
"),     Text(
          extent={{76,182},{94,162}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Ri
"),     Text(
          extent={{38,154},{56,134}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Cr"),
        Text(
          extent={{110,190},{128,170}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Ci
"),     Text(
          extent={{126,168},{144,148}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Ti
"),     Text(
          extent={{20,130},{38,110}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Tr
"),     Text(
          extent={{-194,190},{-178,158}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Shgc
...
"),     Text(
          extent={{-164,-96},{-132,-138}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Hmax"),
        Text(
          extent={{-168,-38},{-136,-80}},
          lineColor={238,46,47},
          textStyle={TextStyle.Bold},
          fontSize=24,
          textString="Vmax"),
