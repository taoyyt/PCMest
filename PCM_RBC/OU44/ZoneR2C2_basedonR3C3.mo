within OU44;
model ZoneR2C2_basedonR3C3 "single zone model"
...
equation
  ...
  connect(HC_air.port, Rinternal.port_a) annotation (Line(points={{15,88},{26,88},
...
connect(heatFlowSensor.Q_flow, integrator1.u) annotation (Line(points={{-11,
  ...
  connect(Re.port_b, HC_air.port) annotation (Line(points={{-60,81},{-21,81},{-21,
          88},{15,88}}, color={191,0,0}));
  connect(prescribedHeatFlow.port, HC_air.port) annotation (Line(points={{-80,108},
          {-32,108},{-32,88},{15,88}}, color={191,0,0}));
  annotation (
