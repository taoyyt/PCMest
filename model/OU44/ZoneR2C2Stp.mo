...
model ZoneR2C2Stp "Simple zone"
  ...
  Modelica.Blocks.Interfaces.RealInput CO2stp "CO2 setpoint [ppm]"
  ...
  Modelica.Blocks.Continuous.LimPID PID_CO2(
    ...
    Td=0.01,
    controllerType=Modelica.Blocks.Types.SimpleController.PI)
    annotation (Placement(transformation(extent={{-152,-88},{-132,-68}})));
  ...
  Modelica.Blocks.Math.Gain abs(k=-1) annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=180,
        origin={-110,-78})));
equation
  ...
  connect(CO2stp, PID_CO2.u_s)
    annotation (Line(points={{-226,-78},{-154,-78}}, color={0,0,127}));
  ...
  connect(PID_CO2.y, abs.u)
    annotation (Line(points={{-131,-78},{-131,-78},{-122,-78}},
                                                     color={0,0,127}));
  connect(ventilation.u, abs.y)
    annotation (Line(points={{-90,-78},{-99,-78}}, color={0,0,127}));
  connect(cO2_1.CO2, PID_CO2.u_m) annotation (Line(points={{10.6,2},{66,2},{
          66,-100},{-142,-100},{-142,-90}},            color={0,0,127}));
