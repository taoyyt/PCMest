within OU44;
model ZoneR1C1_basedonR3C3 "single zone model"
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Re(R=RExt/(6*Vi^(2/3)))
  ...
  Modelica.Blocks.Continuous.Integrator integrator1(k=1/3600)
    annotation (Placement(transformation(extent={{84,-114},{98,-100}})));
...
equation
  ...
  connect(integrator1.y, Qrad) annotation (Line(points={{98.7,-107},{110.35,
        -107},{110.35,-101},{137,-101}},
                                   color={0,0,127}));
...
connect(heatFlowSensor.Q_flow, integrator1.u) annotation (Line(points={{-11,
        -92},{34,-92},{34,-107},{82.6,-107}}, color={0,0,127}));
  connect(Re.port_b, HC_air.port) annotation (Line(points={{-60,81},{-22,81},{
          -22,88},{15,88}}, color={191,0,0}));
  connect(prescribedHeatFlow.port, HC_air.port) annotation (Line(points={{-80,
          108},{-34,108},{-34,88},{15,88}}, color={191,0,0}));
  annotation (
