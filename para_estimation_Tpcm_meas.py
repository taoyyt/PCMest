...
# Paths
ms_file = os.path.join('data','Tair.csv')
ideal_file=os.path.join('data','Tpcm_measurement.txt')
fmu_file = os.path.join('FMU','para_est.fmu')
res_dir = os.path.join('results','parameter_estimation')
...
ic_param['pcm.heatCapacitor.T'] = 'Tpcm'
